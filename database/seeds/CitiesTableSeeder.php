...
class CitiesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['ad_id' => 8, 'name' => 'Quirihue'],
            ['ad_id' => 6, 'name' => 'Rancagua'],
            ['ad_id' => 8, 'name' => 'Ranquil'],
            ['ad_id' => 6, 'name' => 'Rapel'],
            ['ad_id' => 7, 'name' => 'Rauco'],
